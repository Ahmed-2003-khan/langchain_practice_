...
class Review(BaseModel):
    ...
    pros: Optional[list[str]] = Field(description="List the pros mentioned in the review, if any")
    cons: Optional[list[str]] = Field(description="List the cons mentioned in the review, if any")
    name: Optional[str] = Field(description="Name of the reviewer, if mentioned")
